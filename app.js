...
// pull out the pieces but keep them hard coded
// write logic to make those pieces equal the hard coded values, using parameters
// check that the test passes at each point
...
function sum(a, b) {
  ...
  let concatenatedString =
    'The sum of ' + a + ' and ' + b + ' is ' + addedSum + '.';
...
function multiply(a, b) {
  ...
  let concatenatedString =
    'The product of ' + a + ' and ' + b + ' is ' + multipliedNumbers + '.';
  return [multipliedNumbers, concatenatedString];
}
...
// Write your code here
// write function called sumAndMultiply() that takes three arguments
function sumAndMultiply(a, b, c) {
  ...
  let productOfTwo = multiply(a, b)[0];
  // second element: product of 3 numbers
  let productOfThree = multiply(productOfTwo, c)[0];
...
function sumArray(sumArr) {
  //eslint-disable-line
  // first element in array = sum of numbers in array
  // sum function gives me an array...
  let arraySum = 0;
...
function multiplyAnyArray(dynamicArray) {
  ...
  for (var i = 0; i < dynamicArray.length; i++) {
    productArray = multiply(dynamicArray[i], productArray)[0];
  }
  let multiplyArrayString =
    'The numbers ' + dynamicArray + ' have a product of ' + productArray + '.';
  return [productArray, multiplyArrayString];
}
