...
function multiply(a, b) { //eslint-disable-line
  var product = a * b
  var stringName = 'The product of ' + a + ' and ' + b + ' is ' + product + '.';
  return [product, stringName];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var multiplyArrTotal = 1;
  for (var i = 0; i < multArr.length; i++) {
    multiplyArrTotal = multiply(multiplyArrTotal, multArr[i])[0];
  }
  var multiplyConcatenatedString = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + multiplyArrTotal + '.';
  return [multiplyArrTotal, multiplyConcatenatedString];
};
